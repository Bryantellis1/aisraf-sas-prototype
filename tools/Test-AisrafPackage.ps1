...
if ($validationFails.Count -gt 0) {
    ...
    Add-Result -Status PASS -Check '11-validation-allowed' -Detail "validation/ contains only the Build Package 01-12 documents (plus Build Package 10A corrective-patch checklist and Build Package 11A run-input-refresh checklist)."
}
